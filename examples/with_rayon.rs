...
use status_executor::{RayonContext, StatusExecutor, StatusSender};
...
fn main() {
    ...
    let e1 = StatusExecutor::new(RayonContext::new(&pool), takes_a_while);
    std::thread::sleep(std::time::Duration::from_millis(100));
    let e2 = StatusExecutor::new(RayonContext::new(&pool), takes_a_while);
